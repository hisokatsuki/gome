define(['../thirdplugins/jquery','header'], function (jquery,header) {
    return {
        ...
        banner:!function(){
            $.ajax({
                url:'http://10.31.162.61/myself/gome/php/banner_data.php',
                dataType:'json'
            }).done(function(d){
                var $d=d;
                var $bannerstr='';
        ...
        countdown_data:!function () {
            ...
            $.ajax({
                type: 'get',
                url: 'http://10.31.162.61/myself/gome/php/countdown_data.php',
                dataType: 'json'
            }).done(function (data) {
                var $d = data;
                var $list1 = '';
        ...
        floor_first:!function(){
            $.ajax({
                url:'http://10.31.162.61/myself/gome/php/floorfirst_data.php',
                dataType:'json'
            }).done(function(d){
                var $d=d;
        ...
        floor:!function(){
            $.ajax({
                url:'http://10.31.162.61/myself/gome/php/floorlist_data.php',
                dataType:'json'
            }).done(function(d){
                var $d=d;
